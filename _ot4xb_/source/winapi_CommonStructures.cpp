...
#define _XBST_LPWSTR_DYNSZW( name , dname ) {pc->Member_lpStr( #name);pc->GwstBack();pc->Member_DynSzW( #dname );}
// -----------------------------------------------------------------------------------------------------------------
...
XB_END_STRUCTURE
// ---------------------------------------------------------------------------------------------------------------------
XB_BEGIN_STRUCTURE( STARTUPINFOEX )

_XBST_DWORD( structure_cb )
_XBST_LPSTR( lpReserved )
_XBST_LPSTR_DYNSZ( lpDesktop, cDesktop )
_XBST_LPSTR_DYNSZ( lpTitle, cTitle )
_XBST_DWORD( dwX )
_XBST_DWORD( dwY )
_XBST_DWORD( dwXSize )
_XBST_DWORD( dwYSize )
_XBST_DWORD( dwXCountChars )
_XBST_DWORD( dwYCountChars )
_XBST_DWORD( dwFillAttribute )
_XBST_DWORD( dwFlags )
_XBST_WORD( wShowWindow )
_XBST_WORD( cbReserved2 )
_XBST_LPBYTE( lpReserved2 )
_XBST_HANDLE( hStdInput )
_XBST_HANDLE( hStdOutput )
_XBST_HANDLE( hStdError )
// ----------
_XBST_POINTER( lpAttributeList )
// ----------
pc->ROClassProperty_cbbs( "sizeof_startupinfo", "{ || %i }", sizeof( STARTUPINFOA ) );
pc->ROClassProperty_cbbs( "sizeof_startupinfo_ex", "{ || %i }", sizeof( STARTUPINFOA ) + 4 );
// ----------  // show window constants
pc->ROClassPropertyCB( "swHide", "{|| 0  }" );
pc->ROClassPropertyCB( "swShowNormal", "{|| 1  }" );
pc->ROClassPropertyCB( "swNormal", "{|| 1  }" );
pc->ROClassPropertyCB( "swShowMinimized", "{|| 2  }" );
pc->ROClassPropertyCB( "swShowMaximized", "{|| 3  }" );
pc->ROClassPropertyCB( "swMaximize", "{|| 3  }" );
pc->ROClassPropertyCB( "swShowNoActivate", "{|| 4  }" );
pc->ROClassPropertyCB( "swShow", "{|| 5  }" );
pc->ROClassPropertyCB( "swMinimize", "{|| 6  }" );
pc->ROClassPropertyCB( "swShowMinNoActive", "{|| 7  }" );
pc->ROClassPropertyCB( "swShowNA", "{|| 8  }" );
pc->ROClassPropertyCB( "swRestore", "{|| 9  }" );
pc->ROClassPropertyCB( "swShowDefault", "{|| 10 }" );
pc->ROClassPropertyCB( "swForceMinimize", "{|| 11 }" );
// ----------
pc->PropertyCBMask( "lUseShowWindow"    , 0x0001 ,"dwFlags" );
pc->PropertyCBMask( "lUseSize"          , 0x0002 ,"dwFlags" );
pc->PropertyCBMask( "lUsePosition"      , 0x0004 ,"dwFlags" );
pc->PropertyCBMask( "lUseCountChars"    , 0x0008 ,"dwFlags" );
pc->PropertyCBMask( "lUseFillAttribute" , 0x0010 ,"dwFlags" );
pc->PropertyCBMask( "lRunFullScreen"    , 0x0020 ,"dwFlags" );
pc->PropertyCBMask( "lForceOnFeedback"  , 0x0040 ,"dwFlags" );
pc->PropertyCBMask( "lForceOffFeedback" , 0x0080 ,"dwFlags" );
pc->PropertyCBMask( "lUseStdHandles"    , 0x0100 ,"dwFlags" );

XB_END_STRUCTURE
// ---------------------------------------------------------------------------------------------------------------------
XB_BEGIN_STRUCTURE( STARTUPINFOEXW )
...
_XBST_LPWSTR_DYNSZW( lpDesktop , cDesktop )
_XBST_LPWSTR_DYNSZW( lpTitle, cTitle )
_XBST_DWORD( dwX )
_XBST_DWORD( dwY )
_XBST_DWORD( dwXSize )
_XBST_DWORD( dwYSize )
