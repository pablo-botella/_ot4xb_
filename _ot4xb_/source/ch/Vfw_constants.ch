#ifndef _INC_VFW_constants
#define _INC_VFW_constants
#include mmsystem_constants.ch
#xtranslate MKFOURCC([<ch0>[,<ch1>[,<ch2>[,<ch3>]]]] ) => nOr( nAnd(<ch0>,0xFF) , nLShift( nAnd(<ch1>,0xFF) , 8), nLShift( nAnd(<ch2>,0xFF) , 16), nLShift( nAnd(<ch3>,0xFF) , 24) )
#define ICVERSION       0x0104
#define BI_1632  0x32333631     // '1632'
#xtranslate mmioFOURCC([<ch0>[,<ch1>[,<ch2>[,<ch3>]]]] ) => nOr( nAnd(<ch0>,0xFF) , nLShift( nAnd(<ch1>,0xFF) , 8), nLShift( nAnd(<ch2>,0xFF) , 16), nLShift( nAnd(<ch3>,0xFF) , 24) )
#xtranslate aviTWOCC([<ch0>[,<ch1>]] ) => nOr( nAnd(<ch0>,0xFF) , nLShift( nAnd(<ch1>,0xFF) , 8) )
#define ICTYPE_VIDEO    PeekDWord( 'vidc')
#define ICTYPE_AUDIO    PeekDWord( 'audc')
#ifndef ICERR_OK
#define ICERR_OK                0
...
#define ICERR_UNSUPPORTED     dwminus(   1 )
#define ICERR_BADFORMAT       dwminus(   2 )
#define ICERR_MEMORY          dwminus(   3 )
#define ICERR_INTERNAL        dwminus(   4 )
#define ICERR_BADFLAGS        dwminus(   5 )
#define ICERR_BADPARAM        dwminus(   6 )
#define ICERR_BADSIZE         dwminus(   7 )
#define ICERR_BADHANDLE       dwminus(   8 )
#define ICERR_CANTUPDATE      dwminus(   9 )
#define ICERR_ABORT	         dwminus(  10 )
#define ICERR_ERROR           dwminus( 100 )
#define ICERR_BADBITDEPTH     dwminus( 200 )
#define ICERR_BADIMAGESIZE    dwminus( 201 )
#define ICERR_CUSTOM           dwminus(400)
...
#define ICQUALITY_DEFAULT   dwminus(1)
...
#define ICM_FRAMERATE       PeekDword('FrmR')
#define ICM_KEYFRAMERATE    PeekDword('KeyR')
