...
#define SERVICE_STATE_ALL              nOr(SERVICE_ACTIVE,SERVICE_INACTIVE)
...
#define SC_MANAGER_ALL_ACCESS          nOr(STANDARD_RIGHTS_REQUIRED,SC_MANAGER_CONNECT,SC_MANAGER_CREATE_SERVICE,SC_MANAGER_ENUMERATE_SERVICE,SC_MANAGER_LOCK,SC_MANAGER_QUERY_LOCK_STATUS,SC_MANAGER_MODIFY_BOOT_CONFIG)
...
#define SERVICE_ALL_ACCESS             nOr(STANDARD_RIGHTS_REQUIRED,SERVICE_QUERY_CONFIG,SERVICE_CHANGE_CONFIG,SERVICE_QUERY_STATUS,SERVICE_ENUMERATE_DEPENDENTS,SERVICE_START,SERVICE_STOP,SERVICE_PAUSE_CONTINUE,SERVICE_INTERROGATE,SERVICE_USER_DEFINED_CONTROL)
...
#define SERVICE_SID_TYPE_RESTRICTED                             nOr( 0x00000002,SERVICE_SID_TYPE_UNRESTRICTED )
