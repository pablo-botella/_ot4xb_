...
#include "disphelper.hpp"
#include <math.h>
#include <assert.h>
#define VariantChangeType  _ot4xb_VariantChangeType
extern  HRESULT __declspec(dllexport) _ot4xb_VariantChangeType(__out VARIANTARG * pvargDest, __in const VARIANTARG * pvarSrc, __in USHORT wFlags, __in VARTYPE vt);
/* ----- convert.h ----- */
