...
/*{{class-name_: OT4XB_IUNKNOW
            ...
            | _kw_: COM, IUnknown, QueryInterface, AddRef, Release, interface pointer
   }}*/
...
/*{{class-name_: OT4XB_IDISPATCH
            ...
            | _kw_: COM, IDispatch, Invoke, GetIDsOfNames, automation, interface
   }}*/
...
/*{{class-name_: OT4XB_ISEQUENTIALSTREAM
            ...
            | _kw_: COM, ISequentialStream, Read, Write, stream interface
   }}*/
...
/*{{class-name_: OT4XB_ISTREAM
            ...
            | _kw_: COM, IStream, Seek, Stat, stream interface
   }}*/
