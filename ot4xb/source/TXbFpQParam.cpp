...
/*{{begin-note-id}}*/
/*{{note-id: fp-qtype-prototype
            | title_: The Qualified-call prototype template (QTYPE) }}*/
             /*{{|:
             Qualified-call functions - FpQCall, IFpQCall, FpLQCall, FpLQCall2 - take an explicit prototype
             string instead of inferring the argument types from the Xbase++ values.

             cPrototype is a concatenation of 4-byte codes: it starts with the return value and ends with the
             last parameter - one code for the return, then one per parameter.
             __vo is a void return; as the first parameter it means "no parameters", like C's (void).

             Template Components for parameters :
             |include-note-id: qcall-parameter-values
             |note:
             ...
             Example - socket( int, int, int ) -> SOCKET is "__sl" + "__sl" + "__sl" + "__sl" (the SOCKET
             return followed by three int parameters).
...
//----------------------------------------------------------------------------------------------------------------------
/*{{begin-note-id}}*/
/*{{note-id: qcall-parameter-values }}*/
BOOL TXbFpQParam::InitParam( XppParamList pl, ULONG nPos, DWORD dwq )
{
   ...
   /*{{|:
   - `__vo`  void  ;   The funcion not take any parameters.Will be an error if appear after the first parameter position.}}*/


   /*{{|:
   - `@?sl`  This is a especial template that behave like `_@sl` if the provided xb parameter in numeric and like `__pt` otherwise  }}*/
   ...
   switch( m_dwq )
   {
      ...
      case QT_LPXBASE: { IO_QT_LPXBASE( 0 ); return TRUE; }      /*{{|note: - `__xb`    QT_LPXBASE      |include-note-id: IO_QT_LPXBASE }}*/
      case QT_BOOL: { IO_QT_BOOL( 0 ); return TRUE; }            /*{{|note: - `__bo`    QT_BOOL         |include-note-id: IO_QT_BOOL }}*/
      case QT_BYTEBOOL: { IO_QT_BYTEBOOL( 0 ); return TRUE; }    /*{{|note: - `__bb`    QT_BYTEBOOL     |include-note-id: IO_QT_BYTEBOOL }}*/
      case QT_INT8: { IO_QT_INT8( 0 ); return TRUE; }            /*{{|note: - `__sc`    QT_INT8         |include-note-id: IO_QT_INT8 }}*/
      case QT_BYTE: { IO_QT_BYTE( 0 ); return TRUE; }            /*{{|note: - `__uc`    QT_BYTE         |include-note-id: IO_QT_BYTE }}*/
      case QT_INT16: { IO_QT_INT16( 0 ); return TRUE; }          /*{{|note: - `__ss`    QT_INT16        |include-note-id: IO_QT_INT16 }}*/
      case QT_WORD: { IO_QT_WORD( 0 ); return TRUE; }            /*{{|note: - `__us`    QT_WORD         |include-note-id: IO_QT_WORD }}*/
      case QT_INT32: { IO_QT_INT32( 0 ); return TRUE; }          /*{{|note: - `__sl`    QT_INT32        |include-note-id: IO_QT_INT32 }}*/
      case QT_DWORD: { IO_QT_DWORD( 0 ); return TRUE; }          /*{{|note: - `__ul`    QT_DWORD        |include-note-id: IO_QT_DWORD }}*/
      case QT_INT64: { IO_QT_INT64( 0 ); return TRUE; }          /*{{|note: - `__sq`    QT_INT64        |include-note-id: IO_QT_INT64 }}*/
      case QT_QWORD: { IO_QT_QWORD( 0 ); return TRUE; }          /*{{|note: - `__uq`    QT_QWORD        |include-note-id: IO_QT_QWORD }}*/
      case QT_FLOAT: { IO_QT_FLOAT( 0 ); return TRUE; }          /*{{|note: - `__f4`    QT_FLOAT        |include-note-id: IO_QT_FLOAT }}*/
      case QT_DOUBLE: { IO_QT_DOUBLE( 0 ); return TRUE; }        /*{{|note: - `__f8`    QT_DOUBLE       |include-note-id: IO_QT_DOUBLE }}*/
      case QT_POINTER: { IO_QT_POINTER( 0 ); return TRUE; }      /*{{|note: - `__pt`    QT_POINTER      |include-note-id: IO_QT_POINTER }}*/
      case QT_LPBOOL: { IO_QT_LPBOOL( 0 ); return TRUE; }        /*{{|note: - `_@bo`    QT_LPBOOL       |include-note-id: IO_QT_LPBOOL }}*/
      case QT_LPBYTEBOOL: { IO_QT_LPBYTEBOOL( 0 ); return TRUE; }/*{{|note: - `_@bb`    QT_LPBYTEBOOL   |include-note-id: IO_QT_LPBYTEBOOL }}*/
      case QT_LPINT8: { IO_QT_LPINT8( 0 ); return TRUE; }        /*{{|note: - `_@sc`    QT_LPINT8       |include-note-id: IO_QT_LPINT8 }}*/
      case QT_LPBYTE: { IO_QT_LPBYTE( 0 ); return TRUE; }        /*{{|note: - `_@uc`    QT_LPBYTE       |include-note-id: IO_QT_LPBYTE  }}*/
      case QT_LPINT16: { IO_QT_LPINT16( 0 ); return TRUE; }      /*{{|note: - `_@ss`    QT_LPINT16      |include-note-id: IO_QT_LPINT16 }}*/
      case QT_LPWORD: { IO_QT_LPWORD( 0 ); return TRUE; }        /*{{|note: - `_@us`    QT_LPWORD       |include-note-id: IO_QT_LPWORD  }}*/
      case QT_LPINT32: { IO_QT_LPINT32( 0 ); return TRUE; }      /*{{|note: - `_@sl`    QT_LPINT32      |include-note-id: IO_QT_LPINT32 }}*/
      case QT_LPDWORD: { IO_QT_LPDWORD( 0 ); return TRUE; }      /*{{|note: - `_@ul`    QT_LPDWORD      |include-note-id: IO_QT_LPDWORD }}*/
      case QT_LPINT64: { IO_QT_LPINT64( 0 ); return TRUE; }      /*{{|note: - `_@sq`    QT_LPINT64      |include-note-id: IO_QT_LPINT64 }}*/
      case QT_LPQWORD: { IO_QT_LPQWORD( 0 ); return TRUE; }      /*{{|note: - `_@uq`    QT_LPQWORD      |include-note-id: IO_QT_LPQWORD }}*/
      case QT_LPFLOAT: { IO_QT_LPFLOAT( 0 ); return TRUE; }      /*{{|note: - `_@f4`    QT_LPFLOAT      |include-note-id: IO_QT_LPFLOAT }}*/
      case QT_LPDOUBLE: { IO_QT_LPDOUBLE( 0 ); return TRUE; }    /*{{|note: - `_@f8`    QT_LPDOUBLE     |include-note-id: IO_QT_LPDOUBLE }}*/
      case QT_STR2WIDE: { IO_QT_STR2WIDE( 0 ); return TRUE; }    /*{{|note: - `c_sw`    QT_STR2WIDE     |include-note-id: IO_QT_STR2WIDE }}*/
      case QT_STR2WIDE_W: { IO_QT_STR2WIDE_W( 0 ); return TRUE; }/*{{|note: - `c@sw`    QT_STR2WIDE_W   |include-note-id: IO_QT_STR2WIDE_W }}*/
      case QT_HWND: { IO_QT_HWND( 0 ); return TRUE; }            /*{{|note: - `__hw`    QT_HWND         |include-note-id: IO_QT_HWND }}*/
      case QT_VARIANT: { IO_QT_VARIANT( 0 ); return TRUE; }      /*{{|note: - `__vt`    QT_VARIANT      |include-note-id: IO_QT_VARIANT }}*/
   }
...
//----------------------------------------------------------------------------------------------------------------------
/*{{begin-note-id}}*/
/*{{note-id: qcall-return-values
            | title_: How a Qualified call converts the return value }}*/
             /*{{|:
             FCall converts the return value back to Xbase++ from the return code (see fp-qtype-prototype):

               __vo          no value
               __bo          a logical
               __sc  __ss    a number, sign-extended
               __uc  __us    a number, zero-extended
               __ul          a number (a double when the top bit is set, to keep the full range)
               __sq  __uq    an 8-byte binary string (the raw 64-bit value)
               __f4  __f8    a number
               c_sz          a string read from the returned char pointer
               c_sw          a string from the returned wide pointer
               __xb          the returned Xbase variable
               anything else a number (the raw 32-bit result)

             For c_sz and c_sw the returned pointer is also kept as the thread "last pointer"
             (QFpGetLastPointer, see qfp-last-pointer).
             }}*/
/*{{end-note-id}}*/
